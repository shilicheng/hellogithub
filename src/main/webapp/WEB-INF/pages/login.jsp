...
<html lang="zh-CN">
  ...
  <body>
    ...
    <div class="container">
      ...
      <form action="${PATH}/dologin" method="post" class="form-signin" role="form">
        <h2 class="form-signin-heading"><i class="glyphicon glyphicon-log-in"></i> 用户登录</h2>
          <h7>${requestScope.errorMsg}</h7>
        ...
        <a class="btn btn-lg btn-success btn-block" onclick="document.getElementsByTagName('form')[0].submit()" > 登录</a>
      </form>
    </div>
